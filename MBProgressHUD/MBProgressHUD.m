...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
        self.labelFont = [XGUtils defaultBoldFontOfSize:kLabelFontSize];// [UIFont boldSystemFontOfSize:kLabelFontSize];
		self.detailsLabelFont = [XGUtils defaultBoldFontOfSize:kDetailsLabelFontSize];//[UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
